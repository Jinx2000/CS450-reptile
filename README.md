...
data/  
  ...
  multi_temp_csv/
   ├── final_output_\<category>.csv (generated by Multi_Facade.py)
requirements.txt  
README.md  
```
...
1. Create (or edit) a text file with one URL per line @ `data/multi_url.txt`. (If not provided, a testing one will be generated)
2. Run:
```bash
